# -*- coding: utf-8 -*-
"""
Created on Wed Sep 19 15:37:09 2012
...
from ui_raytracer import Ui_Form
...
class Main(QtGui.QWidget):
    ...
    def populate(self):
        ...
        # adding lines    
        prev_point = (randint(0,500),randint(150,300))
        for i in range(10):
            next_point = (randint(0,500),randint(150,300))
            l = QtGui.QGraphicsLineItem()
            l.setLine(prev_point[0], prev_point[1],
